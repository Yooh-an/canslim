...
def main():
    ...
    parser.add_argument(
        "--mode",
        required=True,
        choices=["download", "parse", "enrich", "leadership", "financials", "screen"],
        help="Operation mode: download SEC data, parse data, enrich with market data, enrich leadership data, collect financial data, or screen stocks"
    )
